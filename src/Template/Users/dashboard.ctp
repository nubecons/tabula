...
<!-- content -->
  <?php /*?><div id="content" class="app-content" role="main">
            ...
            <ul class="list-group list-group-lg m-b-none">
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="<?=$site_url?>img/a1.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="<?=$site_url?>img/a2.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="<?=$site_url?>img/a3.jpg" class="r r-2x">
                </a>
              ...
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="<?=$site_url?>img/a4.jpg" class="r r-2x">
                </a>
                <span class="pull-right label bg-warning inline m-t-sm">Editor</span>
          ...
          <div class="list-group list-group-lg list-group-sp">
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a4.jpg" alt="...">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a6.jpg" alt="...">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a7.jpg" alt="...">
                <i class="busy b-white right"></i>
              </span>
              <span class="clear">
            ...
            <a herf class="list-group-item clearfix">
              <span class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a8.jpg" alt="...">
          ...
          <ul class="list-group no-bg no-borders pull-in">
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a4.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a5.jpg" alt="..." class="img-circle">
                <i class="on b-white bottom"></i>
              </a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a6.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a7.jpg" alt="..." class="img-circle">
            ...
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="<?=$site_url?>img/a8.jpg" alt="..." class="img-circle">
                <i class="away b-white bottom"></i>
              </a>
              <div class="clear">
      ...
      <div role="tabpanel" class="tab-pane tab-2" id="tab-2">
        <div class="wrapper-md">
          ...
          <ul class="list-group no-borders pull-in auto">
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img src="<?=$site_url?>img/a1.jpg" alt="..." class="img-circle"></span>
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img src="<?=$site_url?>img/a2.jpg" alt="..." class="img-circle"></span>
              <a href="#" class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img src="<?=$site_url?>img/a3.jpg" alt="..." class="img-circle"></span>
              <a href class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
            ...
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img src="<?=$site_url?>img/a4.jpg" alt="..." class="img-circle"></span>
              <a href class="text-muted" ui-toggle-class="show" target=".app-aside-right"><i class="fa fa-comment-o pull-right m-t-sm text-sm"></i></a>
              <div class="clear">
      ...
      <div class="row-row">
        <div class="cell">
          <div class="cell-inner padder">
            <!-- chat list -->
            <div class="m-b">
              <a href class="pull-left thumb-xs avatar"><img src="<?=$site_url?>img/a2.jpg" alt="..."></a>
              <div class="clear">
            ...
            <div class="m-b">
              <a href class="pull-right thumb-xs avatar"><img src="<?=$site_url?>img/a3.jpg" class="img-circle" alt="..."></a>
              <div class="clear">
