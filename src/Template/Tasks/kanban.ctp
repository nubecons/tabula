...
<?php /*?><script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script><?php */?> 
<script>
    ...
    $( ".drag_body" ).sortable({
	 ...
	 /* onEnd: function( event, ui ) {
		  alert('aasdasd');
		    ...
		    status = ui.item.parent(".panel-body").attr('id');
			id     = ui.item.attr('id');
		    $.ajax({
				type:'POST',
...
//$('.drag_body').sortable().bind('sortupdate', function() { alert('123');
