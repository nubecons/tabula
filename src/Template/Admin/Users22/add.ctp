          ...
          <div class="clearfix"></div>
            ...
            <?php
			 if(isset($error) && $error != ''){?>
              ...
              <?php } ?>
        	<?php echo $this->Form->create('' ,['class' => "acc_form cp_form form-request" ] ); ?>
            <input type="hidden" name="process" id="process" value="0" >
         
   <p>       
         Enter contact information below and click "Submit":
  </p>
               ...
               <div class="rp-half-control">
                ...
                <div class="rp-half-control">
                        <div class="rp-half">
                            ...
                            <?php echo $this->Form->password('password', [ 'class'=>'blue_inp', "size" => "20"]); ?>
                            <div class="clearfix"></div>
                        </div>
                        <div class="rp-half addclass-rphalf">
                             <label class="blue-bold label-margin">Re-enter Password </label>
                              <?php echo $this->Form->password('password_confirm', [ 'class'=>'blue_inp', "size" => "20"]); ?>
                            <div class="clearfix"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
