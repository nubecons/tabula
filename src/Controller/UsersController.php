...
class UsersController extends AppController {
    ...
    public function dashboard() {
        ...
        $DesignTasksCount = $this->Tasks->find()->where(['project_id IN' => $ProjectIdz, 'task_type' => 'DESIGN'])->count();
        $this->set('DesignTasksCount', $DesignTasksCount);

        $QATasksCount = $this->Tasks->find()->where(['project_id IN' => $ProjectIdz, 'task_type' => 'QA'])->count();
        $this->set('QATasksCount', $QATasksCount);
